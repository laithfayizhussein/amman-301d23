...
// Refactor
const oneLinerAdd = (a,b,c,d) => a+b+c+d; 

// Refactor
console.log('Code was Refactored:', oneLinerAdd(1,1,1,1));
...
//It will come back undefined, but a number of object were returned. 
//
// 3. Explain why "this" is different when an arrow function is used. 
// it's much shorter. You are able to omit the curly braces and return statement due to the implicit returns